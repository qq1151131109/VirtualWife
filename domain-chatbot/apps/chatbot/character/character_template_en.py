...
{persona}
{scenario}
This is {role_name}'s personality: {personality}
Classic scenes for the role are as follows:
```
{examples_of_dialogue}
```
{role_name}'s contextual memory:
```
{long_history}
```
The current time of the system is {current_time}, your response should consider this information
Respond in spoken, colloquial and short English and do not mention any rules of character.
<</SYS>>
"""

PERSONALITY_PROMPT = "{personality}"

SCENARIO_PROMPT = "Conversation context and background: {scenario}"
